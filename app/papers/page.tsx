  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-6">
        {papers.map((paper) => (
          <article key={paper.slug} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft transition hover:border-slate-300 dark:border-slate-800 dark:bg-slate-950">
